...
CURRENT_BACKUP_PATH = os.path.join(BACKUP_DIR, f"update_v13_{TIMESTAMP}")
...
export default function App() {
  ...
  const resetRoute = () => {
      ...
      if (confirm("Reiniciar todo o progresso desta rota? Todas as entregas voltarão para pendente.")) {
          ...
          // Mantém a otimização, mas reseta o status
      ...
      <div className="flex flex-col h-screen bg-slate-50 relative">
          ...
          <div className="bg-white px-5 py-4 shadow-sm z-20 sticky top-0">
              <div className="flex items-center justify-between mb-4">
                  ...
                  {/* BOTÕES DE HEADER: REINICIAR E EXCLUIR */}
...
def main():
    print(f"--- Iniciando V13 {TIMESTAMP} ---")
    ...
    subprocess.run(f'git commit -m "Update V13: Correção Excluir, Reiniciar e Destaques - {TIMESTAMP}"', shell=True)
