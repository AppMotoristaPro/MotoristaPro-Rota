...
CURRENT_BACKUP_PATH = os.path.join(BACKUP_DIR, f"update_v37_{TIMESTAMP}")

# CHAVE API
API_KEY_VALUE = "AIzaSyB8bI2MpTKfQHBTZxyPphB18TPlZ4b3ndU"

# --- 1. ROUTE LIST (SEM LAPIS, SEM BOTAO EDITAR) ---
...
# --- 2. APP (SAFE AREA PADDING + GRAPHICS) ---
...
def main():
    print(f"--- Iniciando V37 (Polish + Charts) {TIMESTAMP} ---")
    ...
    subprocess.run(f'git commit -m "Update V37: UI Polish & Charts - {TIMESTAMP}"', shell=True)
