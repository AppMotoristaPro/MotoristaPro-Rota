...
CURRENT_BACKUP_PATH = os.path.join(BACKUP_DIR, f"update_v14_{TIMESTAMP}")
...
def main():
    print(f"--- Iniciando Fix V14 {TIMESTAMP} ---")
    ...
    subprocess.run(f'git commit -m "Update V14: Fix Syntax Error - {TIMESTAMP}"', shell=True)
