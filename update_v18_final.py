...
# 1. CSS (Ajustes para Botões Grandes)
...
.btn-action-lg {
  height: 56px; /* Mais alto para facilitar o toque */
  font-size: 14px;
      ...
      <div className="flex flex-col h-screen bg-slate-50">
          <div className="bg-white px-5 py-4 shadow-sm z-20 sticky top-0">
              ...
              <div className="flex gap-3">
                  <button onClick={optimizeRoute} className={`flex-1 py-3 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition ${!activeRoute.optimized ? 'btn-highlight animate-pulse' : 'btn-secondary'}`}>
...
def main():
    print(f"🚀 ATUALIZAÇÃO V18 (ROUTE MASTER) - {APP_NAME}")
    ...
    subprocess.run('git commit -m "feat: V18 Big Buttons, Real Address & Better Math"', shell=True)
