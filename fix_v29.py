...
CURRENT_BACKUP_PATH = os.path.join(BACKUP_DIR, f"update_v29_{TIMESTAMP}")

# CHAVE API
API_KEY_VALUE = "AIzaSyB8bI2MpTKfQHBTZxyPphB18TPlZ4b3ndU"

# --- 1. MAP VIEW (UNDO BUTTON + FIXED LABELS) ---
...
# --- 2. ROUTE LIST (TITULOS FIXOS E EDIT PREENCHIDO) ---
...
# --- 3. APP (COM UNDO E LÓGICA DE ID NULO) ---
...
def main():
    print(f"--- Iniciando V29 (Labels Fixas e Undo) {TIMESTAMP} ---")
    ...
    subprocess.run(f'git commit -m "Update V29: Fixed Labels + Undo Button - {TIMESTAMP}"', shell=True)
