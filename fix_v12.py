...
CURRENT_BACKUP_PATH = os.path.join(BACKUP_DIR, f"update_v12_{TIMESTAMP}")

# CHAVE API
API_KEY_VALUE = "AIzaSyB8bI2MpTKfQHBTZxyPphB18TPlZ4b3ndU"

# --- CONTEÚDO DO APP.JSX (SEM F-STRING) ---
# Usamos um placeholder __API_KEY__ para substituir depois de forma segura
...
const DB_KEY = 'mp_db_v53_global_opt_fix';
...
def main():
    print(f"--- Iniciando V12 {TIMESTAMP} ---")
    ...
    subprocess.run(f'git commit -m "Update V12: Otimização Global + Lotes (Corrigido) - {TIMESTAMP}"', shell=True)
