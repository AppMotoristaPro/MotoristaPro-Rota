...
CURRENT_BACKUP_PATH = os.path.join(BACKUP_DIR, f"update_v42_{TIMESTAMP}")
...
def main():
    print(f"--- Iniciando V42 (Advanced Dashboard Pro) {TIMESTAMP} ---")
    ...
    subprocess.run(f'git commit -m "Update V42: Advanced Dashboard Metrics & Charts - {TIMESTAMP}"', shell=True)
